...
$iduser = $_SESSION['id'];
    ...
    $idcarrinho = $id['IdCompra'];
        ...
        if(isset($resultCompra)){
            ...
            #Log
            $sql = "INSERT INTO log (fk_logtipo, tempolog, fk_idusuario) values ('6', '$time' ,'{$_SESSION['id']}')";
            }else {
            ...
            #Log
            $sql = "INSERT INTO log (fk_logtipo, tempolog, fk_idusuario) values ('5', '$time' ,'{$_SESSION['id']}')";
            }
...
while($compra_produto=  mysqli_fetch_assoc($qu)){
    ...
    {
        $sqlcompra1="        
        select * from compra_produto where FKCOMPRA={$idcarrinho}
        ";
        ...
        $SQL = "
            ...
            ";
        #Log
        $sqlog = "INSERT INTO log (fk_logtipo, tempolog, fk_idusuario) values ('3', '$time' ,'{$_SESSION['id']}')";

        header("Refresh:0");
        mysqli_query($con, $SQL);
        mysqli_query($con, $sqlog);
        }else{
            echo "<p>Adiocione algo no carrinho primeiro!</p>";
        }
